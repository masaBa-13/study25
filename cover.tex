...
\newcommand{\eauthor}{SUKEKAWA Masaharu}

\newcommand{\jadvisor}{和田雅昭}
\newcommand{\eadvisor}{WADA Masaaki}
...
\newcommand{\jkeywords}{洋上風力発電, 沿岸漁業, 可視化, GIS, 松前町} % キーワード（日）
\newcommand{\ekeywords}{Offshore wind power, Coastal fisheries, Visualization, GIS, Matsumae town}   % キーワード（英）
